...
instruction!(
    ...
    0x82 => [ () ] => IXor(),
    0x83 => [ () ] => LXor(),
    0x84 => [ a: be_u8 >> b: be_u8 >> ( ( a, b ) ) ] => IInc( a: u8, b: u8 ),
    0x85 => [ () ] => I2L(),
    0x86 => [ () ] => I2F(),
    0x87 => [ () ] => I2D(),
    0x88 => [ () ] => L2I(),
    ...
    0x97 => [ () ] => DCmpL(),
    0x98 => [ () ] => DCmpG(),
    0x99 => [ a: be_i16 >> ( ( a ) ) ] => Ifeq( a: i16 ),
    0x9a => [ a: be_i16 >> ( ( a ) ) ] => Ifne( a: i16 ),
    0x9b => [ a: be_i16 >> ( ( a ) ) ] => Iflt( a: i16 ),
    0x9c => [ a: be_i16 >> ( ( a ) ) ] => Ifge( a: i16 ),
    0x9d => [ a: be_i16 >> ( ( a ) ) ] => Ifgt( a: i16 ),
    0x9e => [ a: be_i16 >> ( ( a ) ) ] => Ifle( a: i16 ),
    0x9f => [ a: be_i16 >> ( ( a ) ) ] => IfICmpEQ( a: i16 ),
    0xa0 => [ a: be_i16 >> ( ( a ) ) ] => IfICmpNE( a: i16 ),
    0xa1 => [ a: be_i16 >> ( ( a ) ) ] => IfICmpLT( a: i16 ),
    0xa2 => [ a: be_i16 >> ( ( a ) ) ] => IfICmpGE( a: i16 ),
    0xa3 => [ a: be_i16 >> ( ( a ) ) ] => IfICmpGT( a: i16 ),
    0xa4 => [ a: be_i16 >> ( ( a ) ) ] => IfICmpLE( a: i16 ),
    0xa5 => [ a: be_i16 >> ( ( a ) ) ] => IfACmpEQ( a: i16 ),
    0xa6 => [ a: be_i16 >> ( ( a ) ) ] => IfACmpNE( a: i16 ),
    0xa7 => [ a: be_i16 >> ( ( a ) ) ] => Goto( a: i16 ),
    0xa8 => [ a: be_i16 >> ( ( a ) ) ] => JSR( a: i16 ),
